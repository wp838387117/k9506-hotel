...
<div style="display: none;margin-top: 20px;" id="saveRoomsDiv">
    ...
    <div class="layui-upload" align="center" style="margin-bottom: 20px;">
        <div class="layui-upload-list">
            <img class="layui-upload-img" id="demo1" src="http://pxciogtf9.bkt.clouddn.com/moren.jpg" width="150px" height="150px"/>
            <p id="demoText"></p>
        </div>
    ...
    <form class="layui-form layui-form-pane" action="" style="margin-left: 50px;">
        <input type="hidden" name="roomPic" id="roomPicId" value="http://pxciogtf9.bkt.clouddn.com/moren.jpg"/>
