...
<div class="layui-layout layui-layout-admin">
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-left">
			<c:forEach items="${dataList}" var="firstAuthMap">
				<li class="layui-nav-item">
					<a href="javascript:;"><i class="layui-icon">
						<c:if test="${firstAuthMap['firstAuthId']==1}">
							&#xe63c;
						</c:if>
						<c:if test="${firstAuthMap['firstAuthId']==2}">
							&#xe62a;
						</c:if>
						<c:if test="${firstAuthMap['firstAuthId']==3}">
							&#xe770;
						</c:if>
						<c:if test="${firstAuthMap['firstAuthId']==4}">
							&#xe68e;
						</c:if>
						<c:if test="${firstAuthMap['firstAuthId']==5}">
							&#xe716;
						</c:if>
						<c:if test="${firstAuthMap['firstAuthId']==6}">
							&#xe63a;
						</c:if>
					</i>${firstAuthMap['firstAuthName']}</a>
					<dl class="layui-nav-child" style="padding-left: 15px">
						<c:forEach items="${firstAuthMap['secondAuths']}" var="secondAuth">
							<dd>
